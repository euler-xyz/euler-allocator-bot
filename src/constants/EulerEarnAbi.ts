export const EulerEarnAbi = [
  {
    ...
    inputs: [
      ...
      { name: 'initialTimelock', type: 'uint256', internalType: 'uint256' },
  ...
  },
  {
    type: 'function',
    name: 'acceptCap',
    inputs: [{ name: 'id', type: 'address', internalType: 'contract IERC4626' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    type: 'function',
    name: 'config',
    inputs: [{ name: '', type: 'address', internalType: 'contract IERC4626' }],
    outputs: [
      { name: 'balance', type: 'uint112', internalType: 'uint112' },
      { name: 'cap', type: 'uint136', internalType: 'uint136' },
      { name: 'enabled', type: 'bool', internalType: 'bool' },
      { name: 'removableAt', type: 'uint64', internalType: 'uint64' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    inputs: [{ name: '', type: 'address', internalType: 'contract IERC4626' }],
    outputs: [
      { name: 'value', type: 'uint136', internalType: 'uint136' },
      { name: 'validAt', type: 'uint64', internalType: 'uint64' },
    ],
    stateMutability: 'view',
  },
  {
    ...
    inputs: [
      {
        ...
        components: [
          { name: 'id', type: 'address', internalType: 'contract IERC4626' },
          { name: 'assets', type: 'uint256', internalType: 'uint256' },
        ],
      },
    ],
  ...
  },
  {
    ...
    inputs: [{ name: 'newFeeRecipient', type: 'address', internalType: 'address' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
    ...
    name: 'setIsAllocator',
    inputs: [
      { name: 'newAllocator', type: 'address', internalType: 'address' },
  ...
  },
  {
    type: 'function',
    name: 'submitTimelock',
    inputs: [{ name: 'newTimelock', type: 'uint256', internalType: 'uint256' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    inputs: [{ name: 'indexes', type: 'uint256[]', internalType: 'uint256[]' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    type: 'event',
    name: 'SetName',
    inputs: [{ name: 'name', type: 'string', indexed: false, internalType: 'string' }],
    anonymous: false,
  },
  {
    type: 'event',
